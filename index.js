...
student_score = 848;
if (student_score >= 800) {
    console.log("Student has A grade");
}
if (student_score < 800 && student_score == 600) {
    console.log("Student has B grade");
}
if (student_score < 600 && student_score == 400) {
    console.log("Student has C grade");
}
if (student_score < 400 && student_score == 200) {
    console.log("Student has D grade");
}
else if (student_score < 200) {
